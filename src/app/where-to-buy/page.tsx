...
export const metadata: Metadata = {
  title: "Where to Buy Silver Britannias | Independent Dealer Guide",
  description:
    "Independent guide to buying British Silver Britannia coins. Compare online bullion dealers, local coin shops, and Royal Mint authorized distributors. Learn about premiums, authenticity, and IRA eligibility.",
  alternates: {
  ...
  openGraph: {
    title: "Where to Buy Silver Britannias | Independent Dealer Guide",
    description:
      "Independent guide to buying British Silver Britannia coins from online dealers, local coin shops, and Royal Mint authorized sources.",
  ...
  twitter: {
    ...
    title: "Where to Buy Silver Britannias | Independent Dealer Guide",
    description:
      "Independent guide to buying British Silver Britannia coins. Compare dealers and learn about premiums and authenticity.",
  },
};
...
const onlineDealers = [
  {
    name: "Monex",
    description:
      "A precious metals dealer providing live market data and Silver Britannia coins alongside other silver products.",
    url: SITE_CONFIG.monexLinks.productPage,
  },
  {
    name: "JM Bullion",
    description:
      "An established online precious metals dealer offering Silver Britannias, Silver Eagles, and other government-minted bullion.",
    url: "https://www.jmbullion.com/",
  },
  {
    name: "APMEX",
    description:
      "One of the largest online bullion retailers with a wide selection of Silver Britannia coins in various conditions.",
    url: "https://www.apmex.com/",
  },
  {
    name: "SD Bullion",
    description:
      "An online dealer known for competitive pricing on Silver Britannias and other government-minted bullion products.",
    url: "https://sdbullion.com/",
  },
  {
    name: "Goldline",
    description:
      "A precious metals dealer offering Silver Britannias with personalized service and market insights.",
    url: "https://www.goldline.com/",
  },
  {
    name: "GovMint",
    description:
      "A collectible coins and precious metals dealer specializing in government-issued bullion including Silver Britannias.",
    url: "https://www.govmint.com/",
  },
  {
    name: "Bullion Exchanges",
    description:
      "A New York-based bullion dealer offering Silver Britannia coins with multiple payment options.",
    url: "https://bullionexchanges.com/",
  },
  {
    name: "Provident Metals",
    description:
      "An online bullion dealer offering competitive prices on Silver Britannias and other government bullion.",
    url: "https://www.providentmetals.com/",
  },
  {
    name: "Money Metals Exchange",
    description:
      "A precious metals dealer offering Silver Britannias with price transparency and educational content.",
...
export default function WhereToBuyPage() {
  const webPageSchema = {
    ...
    "@type": "WebPage",
    name: "Where to Buy Silver Britannias | Independent Buying Guide",
    description:
      "Learn where to buy British Silver Britannia coins online and locally, including major dealers, local coin shops, and authorized distributors.",
    url: `${SITE_CONFIG.domain}/where-to-buy`,
    publisher: {
      "@type": "Organization",
  ...
  const itemListSchema = {
    "@context": "https://schema.org",
    "@type": "ItemList",
    name: "Where to buy Silver Britannia coins",
    description:
      "Types of vendors and platforms for purchasing British Silver Britannia coins",
    itemListElement: [
      {
        "@type": "ListItem",
        position: 1,
      ...
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Royal Mint Authorized Distributors",
      },
      {
        "@type": "ListItem",
        position: 3,
        ...
        <div className="max-w-5xl mx-auto px-4 space-y-16">
          ...
          <section className="text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6">
              ...
              <br />
              <span className="text-slate-900">Silver Britannias</span>
            </h1>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-6">
              An independent educational guide to understanding your options
              for purchasing British Silver Britannia coins—featuring .999 fine silver, 
              Royal Mint authenticity, and advanced security features—from various authorized sources.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="card p-6">
                ...
                <p className="text-slate-600 text-sm">
                  ...
                  Silver Britannias typically carry 3-5% premiums over spot
              ...
              <div className="card p-6">
                ...
                <p className="text-slate-600 text-sm">
                  ...
                  coverage. For Silver Britannias, fully insured and discreet
              ...
              <div className="card p-6">
                ...
                <p className="text-slate-600 text-sm">
                  ...
                  Britannias have excellent liquidity, and reputable dealers maintain
              ...
              <div className="card p-6">
                ...
                <p className="text-slate-600 text-sm">
                  Ensure dealers guarantee authenticity. Silver Britannias&apos; 
                  advanced security features (surface animation, micro-text) make 
                  verification straightforward. Reputable dealers provide return 
                  policies if concerns arise.
                </p>
              </div>
              <div className="card p-6">
                <h3 className="text-lg font-semibold text-slate-900 mb-3 flex items-center gap-2">
          ...
          {/* Royal Mint & Authorized Sources */}
          <section>
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4 text-center">
              <span className="accent-text">Royal Mint</span> & Authorized Sources
            </h2>
            <div className="card p-8 max-w-3xl mx-auto">
              <p className="text-slate-600 mb-6">
                Silver Britannia coins are produced exclusively by the Royal Mint at their 
                facility in Llantrisant, Wales—one of the world&apos;s oldest minting institutions 
                with over 1,100 years of history. While the Royal Mint sells directly to the 
                public in some markets, most bullion coins reach investors through authorized 
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-4 mb-6">
                ...
                <p className="text-slate-600 text-sm">
                  The Royal Mint sells Silver Britannias to a network of 
                  <strong className="text-slate-900"> authorized distributors</strong>—large 
                  dealers who meet Royal Mint requirements for volume and handling. These distributors 
                  then sell to smaller dealers and directly to the public, ensuring authenticity 
              ...
              <div className="space-y-3">
                <span className="text-slate-600">
                  ...
                  (direct sales available in some regions), authorized U.S. and international 
                  distributors, and established bullion dealers worldwide.
                </span>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-600 text-center mb-8 max-w-2xl mx-auto">
              Major online dealers offer competitive pricing on Silver Britannia 
          ...
          <section>
            ...
            <div className="card p-8 max-w-3xl mx-auto">
              <p className="text-slate-600 mb-6">
                Local coin shops and bullion dealers commonly stock Silver Britannia 
              ...
              <ul className="space-y-4 mb-6">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-600">
                    ...
                    Walk out with your Silver Britannias the same day, no shipping delays.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-slate-500 mt-1">•</span>
              ...
              <div className="bg-slate-50 rounded-lg p-4">
                <p className="text-slate-500 text-sm">
                  ...
                  in your area. Call ahead to confirm Silver Britannia availability and pricing.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="card p-8 max-w-3xl mx-auto">
              <p className="text-slate-600 mb-6">
                ...
                who handles the regulatory requirements. Silver Britannias are 
                IRS-approved for Precious Metals IRAs.
              </p>
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-4 mb-6">
                <h3 className="text-lg font-semibold text-slate-900 mb-2">
                ...
                <p className="text-slate-600 text-sm">
                  Silver Britannias meet IRS requirements (.999 minimum purity, 
            ...
            <div className="card p-8 max-w-3xl mx-auto">
              ...
              <ul className="space-y-3">
                <li>
                  ...
                  >
                    <span>Monex Britannia pricing</span>
